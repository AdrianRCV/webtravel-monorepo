...
export function TripRequestDetailContent({
  tripRequest,
  error,
  session,
  accessToken,
}: TripRequestDetailContentProps) {
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="mt-1 text-sm text-foreground truncate">
                      {tripRequest.clientEmail ||
                        tripRequest.chatSession?.user?.email ||
                        "No disponible"}
                    </p>
                  </div>
                </div>
              ...
              <div className="rounded-lg border border-border bg-secondary/60 p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="mt-1 text-sm text-foreground">
                      {formatBudget(
                        tripRequest.budgetMin,
                        tripRequest.budgetMax,
                      )}
                    </p>
                  </div>
                </div>
              ...
              <div className="border-t border-border pt-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Link
                      href="/itinerarios"
                      className="inline-flex items-center gap-2 rounded-lg border border-input bg-card px-4 py-2 text-sm font-medium text-foreground hover:bg-secondary/60 transition-colors"
                    >
                      Ver Todos
                    </Link>
                  </div>
              ...
              <div className="border-t border-border pt-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Elimina la conversación, la solicitud y sus itinerarios de
                      forma permanente.
                    </p>
                  </div>
                  <button
